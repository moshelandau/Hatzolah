...
android {
    ...
    defaultConfig {
        applicationId = "com.hatzolah.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 2
        versionName = "1.1.0"
...
dependencies {
    ...
    // Room Database (use KSP for Room)
    implementation("androidx.room:room-runtime:2.6.1")
    implementation("androidx.room:room-ktx:2.6.1")
    ksp("androidx.room:room-compiler:2.6.1")

    // Hilt Dependency Injection (use kapt for Hilt)
    ...
    // Coroutines <-> Google Play Services Task interop (required by Firebase .await())
