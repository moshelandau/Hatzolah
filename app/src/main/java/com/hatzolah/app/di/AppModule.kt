    ...
    fun provideDatabase(@ApplicationContext context: Context): HatzolahDatabase {
        return Room.databaseBuilder(
            ...
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                for (h in hospitals) {
                    db.execSQL("INSERT INTO hospitals (name, address, erLocation, accessCodes, kosherRoomLocation, latitude, longitude, mainHotline, obHotline, departmentHotlines, communicationSystem, bedAvailability, additionalNotes) VALUES $h")
                }
            }
